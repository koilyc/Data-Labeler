...
class TopToolbarController:
    ...
    def open_folder(self):
        ...
        if folder_path:
            self.main_ui_controller.image_folder_controller.folder_path = folder_path
    ...
    def ocr_current_image(self):
        self.main_ui_controller.image_editor_controller.ocr_current_image()

    def bind_shortcuts(self):
        # 快捷鍵需綁定在主窗口 (tk.Tk) 上，因為快捷鍵僅在當前焦點窗口中有效
        self.parent_Tk.bind("<Control-o>", self.handle_ocr_shortcut)

    def handle_ocr_shortcut(self, event):
