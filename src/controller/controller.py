...
class Controller:
    def __init__(self) -> None:
        ...
        self.tools_controller = ToolsController(self.view.main_window)
    ...
    def bind_shortcuts(self) -> None:
        ...
        self.view.main_window.bind(
            "<Control-o>", self.top_toolbar_controller.ocr_current_image_shortcut
        )
